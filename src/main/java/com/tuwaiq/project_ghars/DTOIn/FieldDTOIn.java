...
public class FieldDTOIn {
    ...
    @NotEmpty(message = "Sorry, the field expected yield can't be empty, please try again")
    @Positive(message = "Sorry, the field expected yield must be positive, please try again")
    private Double expectedYield;
    @NotEmpty(message = "Sorry, the field expected yield time can't be empty, please try again")
